...
class Neurotoxin(MPBase, DPBase, Client):
    ...
    def __init__(self, args, worker_id, train_dataset, test_dataset):
        ...
        self.default_attack_params = {
            'num_sample': 64, 'topk_ratio': 0.1, 'norm_threshold': 0.2, "attack_model": "all2one", 
            "poisoning_ratio": 0.32, "target_label": 6, "source_label": 1, "attack_strategy": "continuous", 
            "single_epoch": 0, "poison_frequency": 5, "attack_start_epoch": None}
    ...
    def local_training(self, model=None, train_loader=None, optimizer=None, criterion_fn=None, local_epochs=None):
        ...
        train_acc, train_loss = super().local_training(model, train_loader, optimizer, criterion_fn, local_epochs)
    ...
    def get_gradient_mask(self):
        ...
        # 直接使用 torch.utils.data.Subset 而不是 subset_by_idx
        sampled_dataset = Subset(self.train_dataset, sample_indices)
